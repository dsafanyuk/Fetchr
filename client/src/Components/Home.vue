      ...
      <section class="hero text-light text-center">
        <div class="container-sm">
          <div class="hero-inner">
            ...
            >Our landing page template works for all the devices, so you only have to setup it once, and get beautiful results forever.</p>
            ...
            <div class="features-wrap">
              <div class="feature is-revealing">
                <div class="feature-inner">
                  ...
                  <p
                    class="text-sm"
                  >often arouses curiosity due to its resemblance to classical latin</p>
                </div>
              </div>
              <div class="feature is-revealing">
                <div class="feature-inner">
                  ...
                  <div class="feature-icon">
                    <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg">
                      <g fill="none" fill-rule="evenodd">
                        ...
                        ></path>
                        <path fill="#03C5A4" d="M12 8h8v8h-8z"></path>
                        <path fill="#0EB3CE" d="M32 0h16v48H32z"></path>
                      </g>
                    </svg>
                  </div>
                  <h4 class="feature-title h3-mobile">Lorem Ipsum</h4>
            ...
            <div class="feature-extended">
              <div class="feature-extended-image is-revealing">
                ...
                >
                  ...
                  <path fill="#F6F8FA" d="M0 220V0h200zM480 140v220H280z"></path>
                  <path
                    fill="#FFF"
                    d="M40 50h400v260H40z"
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-1)"
                  ></path>
                  <path fill="#FFF" d="M40 50h400v260H40z"></path>
                  <path
                    fill="#FFF"
                    d="M103 176h80v160h-80zM320 24h88v88h-88z"
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-1)"
                  ></path>
                  <path fill="#FFF" d="M103 176h80v160h-80zM320 24h88v88h-88z"></path>
                  <path
                    fill="#FFF"
                    d="M230.97 198l16.971 16.971-16.97 16.97L214 214.972z"
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-1)"
                  ></path>
                  <path fill="#02C6A4" d="M230.97 198l16.971 16.971-16.97 16.97L214 214.972z"></path>
                  <path
                    fill="#FFF"
                    d="M203 121H103v100z"
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-1)"
                  ></path>
                  <path fill="#84E482" d="M203 121H103v100z"></path>
                  <circle
                    fill="#FFF"
                    cx="288"
                    cy="166"
                    ...
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-1)"
                  ></circle>
                  <circle fill="#0EB3CE" cx="288" cy="166" r="32" style="mix-blend-mode:multiply"></circle>
                </svg>
              </div>
            ...
            <div class="feature-extended">
              <div class="feature-extended-image is-revealing">
                ...
                >
                  ...
                  <path fill="#F6F8FA" d="M480 140v220H280zM0 220V0h200z"></path>
                  <path
                    fill="#FFF"
                    d="M40 50h400v260H40z"
                  ...
                  <path
                    ...
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-2)"
                  ></path>
                  <path fill="#02C6A4" d="M245.092 218l9.378 22.092-22.093 9.378L223 227.378z"></path>
                  <path
                    fill="#FFF"
                    d="M270 96H170v100z"
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-2)"
                  ></path>
                  <path fill="#84E482" d="M270 96H170v100z"></path>
                  <circle
                    fill="#FFF"
                    cx="296"
                    cy="177"
                    ...
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-2)"
                  ></circle>
                  <circle fill="#0EB3CE" cx="296" cy="177" r="32" style="mix-blend-mode:multiply"></circle>
                </svg>
              </div>
              <div class="feature-extended-body">
                <h3 class="mt-0">Discover</h3>
              ...
              <div class="feature-extended-image is-revealing">
                ...
                >
                  ...
                  <path
                    ...
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-3)"
                  ></path>
                  <path fill="#FFF" d="M72 248h88v88H72zM180 24h80v160h-80z"></path>
                  <path
                    fill="#FFF"
                  ...
                  <path
                    ...
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-3)"
                  ></path>
                  <path fill="#84E482" d="M315 129H215v100z"></path>
                  <circle
                    fill="#FFF"
                    cx="318"
                    cy="219"
                    ...
                    style="mix-blend-mode:multiply;filter:url(#dropshadow-3)"
                  ></circle>
                  <circle fill="#0EB3CE" cx="318" cy="219" r="32" style="mix-blend-mode:multiply"></circle>
                </svg>
              </div>
              <div class="feature-extended-body">
                <h3 class="mt-0">Discover</h3>
              ...
              <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                  <radialGradient cy="0%" fx="50%" fy="0%" r="100%" id="logo-gradient-footer">
                    <stop stop-color="#00A2B8" offset="0%"></stop>
                    <stop stop-color="#00F9D2" offset="100%"></stop>
                  </radialGradient>
                </defs>
                <path
                  d="M16 32C7.163 32 0 24.837 0 16S7.163 0 16 0s16 7.163 16 16-7.163 16-16 16zm0-10a6 6 0 1 0 0-12 6 6 0 0 0 0 12z"
